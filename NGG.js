...
function confirm() {
    ...
    document.getElementById("btmimg").style.display="block";
    document.getElementById("btmimg").style.animation="con 3s linear 1";
    }
    else if(usernum<ans){
...
function playagain() {
   document.getElementById("hilotxt").innerText="...";
    ...
    document.getElementById("btmimg").style.display="none";
    ans = genrandnum();
    attempts = 0;
